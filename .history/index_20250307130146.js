...
// Import mathjs from CDN (without creating a variable)
import 'https://cdn.jsdelivr.net/npm/mathjs@11.8.0/lib/browser/math.js';
...
/**
 * Shows a popup to configure a target success/failure roll
 */
async function configureTargetRoll() {
    const formHtml = `
    <div class="target-roll-form">
        <div class="form-group">
            <label for="dice-count">Number of Dice:</label>
            <input type="number" id="dice-count" min="1" max="100" value="6" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" id="target-value" min="1" max="20" value="8" class="form-control">
        </div>
        <div class="form-group">
            <label>Count Type:</label>
            <div class="radio-group">
                <label>
                    <input type="radio" name="count-type" value="success" checked> 
                    Success (≥ target)
                </label>
                <label>
                    <input type="radio" name="count-type" value="failure"> 
                    Failure (≤ target)
                </label>
            </div>
        </div>
