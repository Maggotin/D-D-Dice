...
const droll = (() => {
    ...
    function roll(formula) {
        ...
        try {
            ...
            console.debug('Dice roll output:', diceRoll); // Debug log
            
            // Use the RPG Dice Roller's built-in output
            return {
                total: diceRoll.total,
                rolls: diceRoll.notation,
                formula: formula
            };
        } catch (error) {
...
function registerMacros() {
    try {
        ...
        // Register the roll macro with proper string handling
        registerMacro('roll', {
            name: 'roll',
            ...
            handler: async (args) => {
                ...
                // Return the result directly - let the macro system handle string conversion
                return result;
            },
            // Tell the macro system this returns a string
            outputType: 'string',
        });
    } catch (error) {
