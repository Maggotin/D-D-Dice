...
function registerMacros() {
    try {
        SillyTavern.getContext().registerMacro('diceroll', async (args) => {
            ...
            try {
                // Use Random.js for validation and rolling
