...
function registerMacros() {
    try {
        ...
        // Get the context and required functions
        const context = SillyTavern.getContext();
        
        // Register a custom macro processor for dice rolls
        context.addCustomMacro({
            name: 'roll',
            process: (args) => {
                console.debug(`Dice roll macro triggered with:`, args);
                let formula = args.trim();
        ...
        // Also register 'rolls' as an alias
        context.addCustomMacro({
            name: 'rolls',
            process: (args) => {
                console.debug(`Dice rolls macro triggered with:`, args);
                let formula = args.trim();
