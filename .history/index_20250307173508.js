...
function registerMacros() {
    try {
        ...
        // Create a macro processor function
        const processDiceRoll = (message) => {
            console.debug('Processing message for dice rolls:', message);
            
            // Define the dice roll macro functions
            const macros = {
                roll: (formula) => {
                    console.debug(`Dice roll macro called with:`, formula);
            ...
            // Use substituteParamsExtended directly
            return SillyTavern.getContext().substituteParamsExtended(message, macros);
        };
        ...
        jQuery(document).on('messageRendered', function(event, messageElement) {
            ...
            if (messageText.includes('{{roll:') || messageText.includes('{{rolls:')) {
                console.debug('Found dice roll macro in message:', messageText);
                const processedText = processDiceRoll(messageText);
