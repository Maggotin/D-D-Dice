...
function registerMacros() {
    try {
        ...
        // Get SillyTavern's global context
        const ST = window.SillyTavern || {};
        
        // Create dice roll functions
        const diceRollFunctions = {
            roll: function(formula) {
                ...
                try {
                    ...
                    console.debug(`Rolled ${diceFormula}: ${result.total}`);
        ...
        // Add dice roll functions to SillyTavern's global macro environment
        ST.macros = ST.macros || {};
        Object.assign(ST.macros, diceRollFunctions);
